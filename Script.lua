...
elseif UserID == 1087968824 or UserID == 1087968824  then  
...
if UserID == 1087968824 or UserID == 1087968824then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1087968824 or UserID == 1087968824then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local inline = {
{{text = '-𝐃𝐄𝐕 👑',url="https:// @NOOR_ELDEEN_0"}},
}   
...
local text = " [مطور السورس🌐 ]( @NOOR_ELDEEN_0)"
local inline = {
{{text = '-𝙳𝙴𝚅 👑',url=" @NOOR_ELDEEN_0"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local text = " 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍 ⩫ "
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝙉𝙊𝙊𝙍 ⩫ ',url="https://t.me/source_noor"}},
{{text = '-𝘿𝙀𝙑   👑',url=" @NOOR_ELDEEN_0"}},
{{text = '-𝙏𝙒𝘼𝙎𝙊𝙇 💬 ',url="https://t.me/JAST_FOR_FUN"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
NameUser = Hyper_Link_Name(data)
if UserID == 1087968824 or UserID == 1087968824then 
...
if msg.adduser == 1087968824 or msg.adduser ==  1087968824 then 
gtupe = 'مطور السورس' 
...
elseif Text== "باسل" or Text== "بيسو" or Text== "بسله" then return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس👑]( @NOOR_ELDEEN_0)")
